$(document).ready(function () {
    ...
    var content = [{
        title: "БҰҰ МЕМЛЕКЕТЫ.",
        desc: "БҰҰ ПРЕЗИГІ МИБЕП"
    }, {
        title: "БҰЛ ЖАКТА",
        desc: "болмайтын прикол айтса рома уксап пизда жиды ягни быр урып уйктатады."
    }, {
        title: "арман сиякты болмандар",
        desc: "пышакталып каласындар"
    }, {
        title: "гарила ышпендер",
        desc: [
            ["<u>айяулым</u>"], " засос салып тастайд".split("")
        ]
    }];
    var currentPage = 0;
    //generate content
